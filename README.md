...
So by that point I was already quite deep into the implementation, so I decided to continue with this API and handle these limitations rather than switching to a different data source.
...
For caching and request state, I would have used `TanStack Query`. It would take care of most of the things I’m currently handling manually, like caching, setting up loading and error states etc, it would make this part of the code much simpler.
